...
class StringConverter extends NullableConverter {
    ...
    private static final ThreadLocal<StringConverter> INSTANCE = new ThreadLocal<StringConverter>() {
        @Override
        protected StringConverter initialValue() {
            return new StringConverter();
        };
    };

    static StringConverter getInstance() {
        return StringConverter.INSTANCE.get();
    }
